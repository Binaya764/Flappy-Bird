...
namespace CE{
    Land::Land(GameDataRef data):_data(data)
    {
        ...
        _data->window.getSize().y-sprite2.getGlobalBounds().height);
    ...
    void Land::MoveLand(float dt)
    {
        ...
        {
            float movement= PIPE_MOVEMENT_SPEED*dt; //for framerate independent gameplay
            _landSprites.at(i).move(-movement,0.0f);

            //If land goes to the left of the screen
